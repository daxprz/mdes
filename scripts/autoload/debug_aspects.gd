...
func _register_all() -> void:
	...
	r.call("player/slide", "Swing-slide-jump: slide initiation, terrain following, launch vectors")
	...
	r.call("player/dash", "Ranger dash: activation, cooldown, trail, jump-carry, ground slide")
