...
const COMMANDS := [
	...
	"strudel listen", "strudel save", "strudel load", "strudel start",
	"strudel fx", "strudel fx off", "strudel effects", "strudel effects off",
	"strudel mode", "strudel mode batch", "strudel mode note",
	"strudel timing", "strudel timing on", "strudel timing off",
