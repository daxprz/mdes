---
xid: EPI-UI-INLINE-PLAYER-HUD-SELECTION
parent: ../design.md
kind: epic
effort: ui
status: in-progress
...
# Inline Player HUD & Selection Rework
...
|---|-----|-------|--------|------|
| 1 | `STO-ui-001` | _(name)_ | open | S/M/L |
...
|-----|----------|--------|-----------|
| `HUG-ui-NNN` | _(major architectural decision)_ | Adopted | _(why)_ |
...
- **Source:** BACKLOG EPIC 27; docs/design/inline_hud_selection.md
- **Shipped in:** v0.9.8
- **History:** Replace menu-based profile/class selection with an always-visible inline HUD at the bottom-center showing 1-4 panels for connected controllers. Players select profile (title only) and class (any state) directly via D-pad, with portal/ghost/poof VFX on class change. The old overlay-based selection system is removed and joining is now auto-on-connect. A small amount of dead-code cleanup remains.
