---
xid: EPI-UI-CONTROLLER-FEATURES
parent: ../design.md
kind: epic
effort: ui
status: shipped
...
- **Source:** BACKLOG EPIC 33
- **Shipped in:** v0.9.5
- **History:** Controller feedback features: haptic rumble across grapple windup/swing/release scaling with velocity, and DualSense-style LED color that matches the player's class color via Godot 4.6 Input.set_joy_light.
