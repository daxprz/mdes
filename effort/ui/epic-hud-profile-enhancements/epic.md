---
xid: EPI-UI-HUD-PROFILE-ENHANCEMENTS
parent: ../design.md
kind: epic
effort: ui
status: shipped
...
- **Source:** BACKLOG EPIC 26
- **Shipped in:** v0.9.8
- **History:** Always-visible HUD showing total muffins and per-player stats, plus profile-flow improvements including auto-join on return from quit-to-menu, fresh-launch-only profile selection, and D-pad class cycling on the title screen.
