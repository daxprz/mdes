---
xid: EPI-DSGN-TOWER-2-DUNGEON-MAZE
parent: ../design.md
kind: epic
effort: dsgn
status: shipped
...
- **Source:** BACKLOG.md EPIC 17; git: 'Tower 2: Top-down dungeon maze replaces side-scrolling tower' (2026-03-15), 'Tower 2 is the dungeon maze again', 'Fix dungeon enemies + balloon shadows'
- **Shipped in:** v0.9.5
- **History:** Replace Tower 2's side-scrolling layout with a top-down maze-style dungeon variant, adding a dedicated dungeon tower scene and script.
