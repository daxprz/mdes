---
xid: EPI-DSGN-LEVEL-DESIGN-VARIETY
parent: ../design.md
kind: epic
effort: dsgn
status: shipped
...
|---|-----|-------|--------|------|
| 1 | `STO-dsgn-001` | _(name)_ | open | S/M/L |
...
|-----|----------|--------|-----------|
| `HUG-dsgn-NNN` | _(major architectural decision)_ | Adopted | _(why)_ |
...
- **Source:** BACKLOG.md EPIC 5; git: 'More platforms in towers: base 12->22, spacing 140->110px' (2026-03-15), 'More moving platforms + thick outer walls', 'Tower 2: even more platforms (87 total)'
- **Shipped in:** v0.9.5
- **History:** Improve tower layouts and platforming challenge so each tower feels distinct and traversable. Tighten platform spacing to match jump height, add multiple routes and secrets, themed visuals, and dynamic platform types.
