---
xid: EPI-SND-AUDIO-EXPANSION-SFX
parent: ../design.md
kind: epic
effort: snd
status: shipped
...
# Audio Expansion — Ability Sound Effects
...
- **Source:** BACKLOG.md EPIC 18: Audio Expansion
- **Shipped in:** v0.9.5
- **History:** Add per-ability sound effects covering the class roster: grappling hook, demolitionist rocket, rogue stealth and backstab, mage beam and air-walk, healer wind gust, melee enrage, ranger reload, and summoner mark. Each .wav was synthesized and wired to its triggering gameplay event.
