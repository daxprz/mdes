---
xid: EPI-SND-MUSIC-COMPOSITION-ARCHITECTURE
parent: ../design.md
kind: epic
effort: snd
status: shipped
...
- **Source:** docs/design/composition_architecture.md; commits 'Composition refactor phases 3-5' (v0.10.41), 'composition architecture' (v0.10.72)
- **Shipped in:** v0.10.72
- **History:** Add a Composition / Movement / Bridge / Turnaround / Record data layer on top of the Strudel engine so music is data independent of any UI. Extracts the line compiler out of the drawer, introduces a bar scheduler that hot-swaps patterns at cycle boundaries, and lets game events transition movements via bridges. Shipped across v0.10.41 (phases 3-5) and v0.10.72-v0.10.75.
