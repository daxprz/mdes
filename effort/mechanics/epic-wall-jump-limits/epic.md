...
- **Source:** BACKLOG EPIC 6
- **Shipped in:** v0.9.18
- **History:** Constrain wall traversal with a depleting wall-cling stamina that regenerates on the ground, a visual exhaustion indicator, and a hard cap of three wall jumps before the player must touch ground.
