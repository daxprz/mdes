...
- **Source:** BACKLOG EPIC 34
- **Shipped in:** v0.9.16
- **History:** Player-experience polish: out-of-bounds teleport to the nearest player with an aether rift VFX, profile class memory that auto-selects the last class on rejoin, and a ghost materialize step before in-game class-change rifts spawn.
