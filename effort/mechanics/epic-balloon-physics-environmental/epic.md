---
xid: EPI-MECH-BALLOON-PHYSICS-ENVIRONMENTAL
parent: ../design.md
kind: epic
effort: mech
status: shipped
...
# Balloon Physics & Environmental Interactions
...
- **Source:** BACKLOG EPIC 25
- **Shipped in:** v0.9.4
- **History:** Advanced physics interactions between balloons, gas, fire, and lava, including chocolate lava igniting H2 gas, fire-type fireballs popping balloons, and group-membership cleanup for dead and stealthed players.
