---
xid: EPI-MECH-ARCHER-AIMED-SHOT
parent: ../design.md
kind: epic
effort: mech
status: shipped
...
- **Source:** BACKLOG EPIC 31
- **Shipped in:** v0.10.71
- **History:** Physics-based arrow aiming with a quadratic arc solver: a hold-to-aim reticle, power control with lockable charge level and direction reversal, and edge-detected fire mechanics with auto re-string that bypass the regular ammo pool.
