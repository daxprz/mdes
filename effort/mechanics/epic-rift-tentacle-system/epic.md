---
xid: EPI-MECH-RIFT-TENTACLE-SYSTEM
parent: ../design.md
kind: epic
effort: mech
status: shipped
...
- **Source:** BACKLOG EPIC 28
- **Shipped in:** v0.9.7
- **History:** A verlet-physics tentacle emerges from a red rift portal when players change class, progressing through confused, hunting, and grab phases. It also grabs and buffs enemies, has its own sub-health that absorbs damage, and enforces tentacle limits with full reset on transitions.
