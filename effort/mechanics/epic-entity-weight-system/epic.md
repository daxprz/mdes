---
xid: EPI-MECH-ENTITY-WEIGHT-SYSTEM
parent: ../design.md
kind: epic
effort: mech
status: shipped
...
- **Source:** BACKLOG EPIC 24
- **Shipped in:** v0.10.31
- **History:** Physics weight values per entity used to drive knockback and push calculations for guitarist blast wave, werewolf roar, and balloon lift. Later refined into an absolute mass model (v0.10.31).
