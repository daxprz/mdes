...
- **Source:** BACKLOG EPIC 29
- **Shipped in:** v0.9.4
- **History:** Health pickups that drop from enemies with a chance on death, heal on contact, despawn after a timer, and play collect VFX.
