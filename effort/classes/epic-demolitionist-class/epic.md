---
xid: EPI-CLS-DEMOLITIONIST-CLASS
parent: ../design.md
kind: epic
effort: cls
status: shipped
...
- **Source:** BACKLOG.md EPIC 9; docs/design/new_classes.md (Demolitionist section)
- **Shipped in:** v0.9.5
- **History:** Explosive area-damage specialist who controls space with arcing bombs. Adds the base class kit, a bomb upgrade system (power, blast size, fragment, napalm), and four mutually-exclusive elemental bomb aspects (electric, fire, impact, ice).
