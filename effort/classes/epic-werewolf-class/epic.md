...
- **Source:** BACKLOG.md EPIC 23
- **Shipped in:** v0.9.5
- **History:** Brutal melee brawler with blood effects and a frenzy mode. Adds the base kit: triple claw combo, roar push, charged pounce leap, and a frenzy attack/move-speed boost.
