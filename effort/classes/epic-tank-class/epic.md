...
- **Source:** BACKLOG.md EPIC 14
- **Shipped in:** v0.9.5
- **History:** Armored frontliner with crowd control and damage absorption. Adds the base kit (mace slam, ground-pound stun, charged shockwave) and a Fortify ability that trades damage output for heavy damage reduction.
