...
- **Source:** BACKLOG.md EPIC 10; docs/design/new_classes.md (Healer section)
- **Shipped in:** v0.9.5
- **History:** Support class with a healing staff that damages enemies while topping up allies. Adds the base kit, a charge-attack healing blast wave that buffs allies and stuns enemies, and a dash that emits a perpendicular healing/push wave.
