...
- **Source:** BACKLOG.md EPIC 21
- **Shipped in:** v0.9.5
- **History:** Chaos controller with physics-based balloons and H2 gas explosions. Adds the base balloon-dart kit plus a lingering hydrogen-gas system that ignites from fire attacks and chains explosions.
