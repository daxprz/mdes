...
- **Source:** BACKLOG.md EPIC 20
- **Shipped in:** v0.9.5
- **History:** Fast aerial specialist with triple jump and dive attacks. Adds the base kit including sequential slices, dive kick, charged meteor strike, an air-dash/item-pickup ability, and triple-jump passive.
