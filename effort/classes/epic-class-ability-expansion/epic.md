---
xid: EPI-CLS-CLASS-ABILITY-EXPANSION
parent: ../design.md
kind: epic
effort: cls
status: shipped
...
|---|-----|-------|--------|------|
| 1 | `STO-cls-001` | _(name)_ | open | S/M/L |
...
|-----|----------|--------|-----------|
| `HUG-cls-NNN` | _(major architectural decision)_ | Adopted | _(why)_ |
...
- **Source:** BACKLOG.md EPIC 15
- **Shipped in:** v0.9.5
- **History:** New abilities added across the existing class roster — Melee Enrage, Ranged ammo/reload + grappling hook, Mage beam/mana-potion/air-walk, Summoner homing mark + delegate mode, Rogue stealth/backstab, Demolitionist jetpack, Healer wind gust/channel — plus a universal aimable-weapons pass.
