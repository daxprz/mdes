...
- **Source:** BACKLOG EPIC 2: Bug Fixes
- **Shipped in:** n/a
- **History:** First wave of defect fixes covering boss arena escape, crash/Variant inference errors, pause menu control, broken attack input, boss damage and floor-clipping, all-players-dead soft-lock, melee ground hits, and the title-screen START button. All stories shipped during the mid-March 2026 stabilization before v0.10.0 tagging began.
