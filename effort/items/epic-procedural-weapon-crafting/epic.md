---
xid: EPI-ITEM-PROCEDURAL-WEAPON-CRAFTING
parent: ../design.md
kind: epic
effort: item
status: open
...
|---|-----|-------|--------|------|
| 1 | `STO-item-001` | _(name)_ | open | S/M/L |
...
|-----|----------|--------|-----------|
| `HUG-item-NNN` | _(major architectural decision)_ | Adopted | _(why)_ |
...
- **Source:** BACKLOG EPIC 8; docs/design/weapon_crafting.md
- **Shipped in:** n/a
- **History:** A large, design-gated feature letting each class craft weapons from three components (per-class slots) that determine stats, visuals, and a procedurally generated bakery-themed name. Includes rarity tiers, a crafting station, material drops, and a mini-muffin currency shop. No implementation has shipped; the backlog marks it as needing a design phase first.
