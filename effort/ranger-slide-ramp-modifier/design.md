...
# Ranger Slide Charge via RampModifierProvider
...
- **Source:** docs/design/ranger_slide_modifiers.md
- **Shipped in:** v0.10.79
- **History:** Extends the static modifier stack with a RampModifierProvider that lerps modifier values over time, used to ramp the slide-charge boost from 1.0x to 1.5x over 2s. Includes the slide config keys, charge/release lifecycle, and a full set of phase visuals plus a player/slide debug aspect.
