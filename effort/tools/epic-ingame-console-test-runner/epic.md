---
xid: EPI-TOOLS-INGAME-CONSOLE-TEST-RUNNER
parent: ../design.md
kind: epic
effort: tools
status: shipped
...
- **Source:** docs/epics/EPIC_ingame_console.md
- **Shipped in:** 0.10.21
- **History:** A Quake-style pop-down console (backtick) that accepts all RCON commands, plus a file-based test system where tests and suites are JSON on disk. A sequential task queue runs setup, wait, check, and aggregation steps and surfaces progress and results in the console.
