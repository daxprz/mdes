---
xid: EPI-TOOLS-DEBUG-DIGITAL-WHITEBOARD
parent: ../design.md
kind: epic
effort: tools
status: shipped
...
- **Source:** docs/epics/EPIC_whiteboard.md; docs/design/whiteboard_implementation.md
- **Shipped in:** 0.10.79
- **History:** A collaborative world-space whiteboard where humans (drawer GUI) and AIs (RCON) diagram and annotate game systems. Supports 12 component types, groups, annotations, control-point editing, grid/component snapping, and component locking, with full JSON round-trip. Built across six phases.
