...
# Splay Editor V2 — Source Detection & Pose Management
...
- **Source:** docs/epics/EPIC_splay_editor_v2.md
- **Shipped in:** 0.9.20
- **History:** Enhances splay authoring with source/dev-mode detection, Original-vs-Custom save workflows, a full pose library with usage tracking and CRUD, and graceful handling of missing pose references in levels.
